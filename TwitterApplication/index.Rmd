...
datatypes=c("character","logical","numeric","character","character","logical","character","character","character","character","character","numeric","logical","logical","character","character")
Tweets <- read.delim("tweets.tsv",colClasses=datatypes,sep="\t")
```
```{r,echo=FALSE}

tail(head(Tweets[,c("screenName","text")],2),1)
```
